...
import AccountFiles from './AccountFiles.jsx';

export default function CustomerDashboard({ accounts, selectedId, transactions, onSelect, onMoveMoney, onTransfer, onUploadDeposit, busy }) {
  ...
  return <div className="banking-layout">
    ...
    <div className="account-workspace">
      {selected ? <>
        ...
        <AccountFiles key={'files-' + selectedId}
          account={selected} onUpload={onUploadDeposit} busy={busy} />
        <TransactionHistory account={selected} transactions={transactions} />
